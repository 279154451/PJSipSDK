...
//    delete();
  ...
  public void libRegisterThread(String name) throws Exception {
    pjsua2JNI.Call_libRegisterThread(swigCPtr, this, name);
  }

  public boolean libIsThreadRegistered() {
    return pjsua2JNI.Call_libIsThreadRegistered(swigCPtr, this);
  }
  ...
  public void onCallDtmf() {
    if (getClass() == Call.class) pjsua2JNI.Call_onCallDtmf(swigCPtr, this); else pjsua2JNI.Call_onCallDtmfSwigExplicitCall(swigCPtr, this);
  }
